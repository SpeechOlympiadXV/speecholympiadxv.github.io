...
<template>
  <main>
    ...
    <AppHeroSection :imagePath="Niru_champ_story">
    ...
    <AppArticle>
      ...
      <p class="box">
        ...
        <b><br />I became the Speech Olympiad XIV champion</b>.
      </p>
      ...
      <ArticleInterview
        ...
        interviewee-name="Niruthika Sritharan"
        :intervieweeImg="NiruthikaPortrait"
      />
    </AppArticle>
  </main>
</template>
