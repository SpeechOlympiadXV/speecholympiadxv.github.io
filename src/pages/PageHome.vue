  ...
  data() {
    return {
      ...
      testimonials: [
        {
          imageSrc: rectangle,
          title: "Sirimevan Jayasundera Champion - SOVI",
        ...
        {
          imageSrc: rectangle,
          title: "Malindi Jayathunga 1st Runner-Up and Best Prepared Speaker - SOXI",
        ...
        {
          imageSrc: rectangle,
          title: "Asitha Rathnayake Champion – SOXII",
        ...
        {
          imageSrc: rectangle,
          title: "Amaya Dharmasiri 1st Runner-Up and Best Impromptu Speaker – SOXII",
